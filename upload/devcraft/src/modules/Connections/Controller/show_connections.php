 ...
 * {include file="devcraft/src/modules/Connections/Controller/show_connections.php?news_id={news-id}&template=chronology&category=chronology"}
 ...
 * {include file="devcraft/src/modules/Connections/Controller/show_connections.php?news_id={news-id}&category_exclude=seasons"}
 *
 * template — подпапка в templates/{skin}/devcraft/connections/{name}/
...
if(isset($category) && trim((string) $category) !== '') {
	$categorySlug = (string) $category;
}

$categoryExclude = isset($category_exclude) ? (string) $category_exclude : null;
